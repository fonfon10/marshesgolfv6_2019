...
Member.create!(firstname: 'Maddy', lastname: 'Pytura', email: 'michaelpytura@gmail.com', password: 'golf123', password_confirmation: 'golf123', membership: membership_type_Coaching, age_group: age_group_type_junior)
...
Member.create!(firstname:	'Bruce'	,lastname:	'Hiscock'	,email:	'can6180@shaw.ca', password: 'golf123', password_confirmation: 'golf123', membership: membership_type_Practice, age_group: age_group_type_adult)
Member.create!(firstname:	'Mark'	,lastname:	'McKay'	,email:	'mmack067@gmail.com', password: 'golf123', password_confirmation: 'golf123', membership: membership_type_Practice, age_group: age_group_type_adult)
Member.create!(firstname:	'Kathleen'	,lastname:	'Parker'	,email:	'rkparker@pgonline.com', password: 'golf123', password_confirmation: 'golf123', membership: membership_type_Practice, age_group: age_group_type_adult)
Member.create!(firstname:	'Rob'	,lastname:	'McNeil'	,email:	'robert.t.mcneil@gmail.com', password: 'golf123', password_confirmation: 'golf123', membership: membership_type_Practice, age_group: age_group_type_adult)
Member.create!(firstname:	'Sam'	,lastname:	'Kloppenburg'	,email:	'sklopp1001@gmail.com', password: 'golf123', password_confirmation: 'golf123', membership: membership_type_Practice, age_group: age_group_type_adult)
Member.create!(firstname:	'Ellis'	,lastname:	'Kinnaird'	,email:	'breakinnaird@gmail.com', password: 'golf123', password_confirmation: 'golf123', membership: membership_type_Coaching, age_group: age_group_type_junior)
